...
public class AddComputerModule extends Page{
	
	public AddComputerModule(WebDriver driver, Log log) throws InvalidFormatException, IOException {
 			super(driver, log);
 	} 
 	...
 	public boolean addComputer(String AccNo, String Testname) throws Exception { 		
